...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/VIPABH/ABH"
    )
    ...
    PMPERMIT_TEXT_ABH = os.environ.get("PMPERMIT_TEXT_ABH", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in ABH
