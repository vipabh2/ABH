...
@ABH.ar_cmd(pattern="زخرفة الصورة(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await edit_delete(
            event,
    ...
    if input_str == "1":
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/jepthon.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Starjedi.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Papernotes.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Terserah.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Photography Signature.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Austein.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Dream MMA.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/EASPORTS15.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/KGMissKindergarten.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/212 Orion Sans PERSONAL USE.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/PEPSI_pl.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Paskowy.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Cream Cake.otf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Hello Valentina.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Alien-Encounters-Regular.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "VIPABH/helpers/styles/Linebeam.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
...
@ABH.ar_cmd(pattern="ميوزك(?:\s|$)([\s\S]*)")
async def variable(event):
    if Config.HEROKU_API_KEY is None:
        return await edit_delete(
            event,
